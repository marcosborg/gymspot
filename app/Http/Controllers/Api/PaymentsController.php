...
class PaymentsController extends Controller
{
    ...
    private function groupAdjacentSlots(array $slots, $client_id)
    {
        ...
        foreach ($groupedSlots as $slot) {
            ...
            $rented_slot->save();
            // CRIAR PASS
            $start_date_time = Carbon::parse($rented_slot->start_date_time)->addHours(2)->timestamp;
            $end_date_time = Carbon::parse($rented_slot->end_date_time)->addHours(2)->timestamp;
