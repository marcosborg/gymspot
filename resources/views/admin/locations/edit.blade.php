    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.locations.update", [$location->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $location->title) }}">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subtitle') ? 'is-invalid' : '' }}" type="text" name="subtitle" id="subtitle" value="{{ old('subtitle', $location->subtitle) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('soon') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="soon" id="soon" value="1" {{ $location->soon || old('soon', 0) === 1 ? 'checked' : '' }}>
