...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.packPurchase.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pack-purchases.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('available') ? 'is-invalid' : '' }}" type="number" name="available" id="available" value="{{ old('available', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('limit_date') ? 'is-invalid' : '' }}" type="text" name="limit_date" id="limit_date" value="{{ old('limit_date') }}" required>
