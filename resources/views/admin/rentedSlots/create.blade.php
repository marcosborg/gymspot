...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.rentedSlot.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.rented-slots.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('end_date_time') ? 'is-invalid' : '' }}" type="text" name="end_date_time" id="end_date_time" value="{{ old('end_date_time') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('keypass') ? 'is-invalid' : '' }}" type="text" name="keypass" id="keypass" value="{{ old('keypass', '') }}">
