...
@can('pack_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.packs.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.pack.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.pack.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Pack">
            <thead>
                <tr>
                    <th width="10">
...
@can('pack_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.packs.massDestroy') }}",
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Pack').DataTable(dtOverrideGlobals);
