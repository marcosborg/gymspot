...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.items.update", [$item->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="icon">{{ trans('cruds.item.fields.icon') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.item.fields.icon_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="video">{{ trans('cruds.item.fields.video') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.item.fields.video_helper') }}</span>
            </div>
            <div class="form-group">
...
@if(isset($item) && $item->icon)
      var file = {!! json_encode($item->icon) !!}
...
@if(isset($item) && $item->video)
      var file = {!! json_encode($item->video) !!}
          this.options.addedfile.call(this, file)
      file.previewElement.classList.add('dz-complete')
