        ...
        <form method="POST" action="{{ route("admin.content-pages.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('slider') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="slider" id="slider" value="1" {{ old('slider', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('steps') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="steps" id="steps" value="1" {{ old('steps', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('about') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="about" id="about" value="1" {{ old('about', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('call') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="call" id="call" value="1" {{ old('call', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('services') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="services" id="services" value="1" {{ old('services', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('gallery') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="gallery" id="gallery" value="1" {{ old('gallery', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('testimonial') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="testimonial" id="testimonial" value="1" {{ old('testimonial', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('location') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="location" id="location" value="1" {{ old('location', 0) == 1 ? 'checked' : '' }}>
