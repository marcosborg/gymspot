        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="card border-0 rounded-0 p-0 mb-5 mb-lg-0 shadow-sm">
                    <img src="assets/website/images/gallery/course-1.jpg" alt="" class="img-fluid">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card border-0 rounded-0 p-0 mb-5 mb-lg-0 shadow-sm">
                    <img src="assets/website/images/gallery/course-2.jpg" alt="" class="img-fluid">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card border-0 rounded-0 p-0 mb-5 mb-lg-0 shadow-sm">
                    <img src="assets/website/images/gallery/course-3.jpg" alt="" class="img-fluid">
